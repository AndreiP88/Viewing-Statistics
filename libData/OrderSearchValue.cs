namespace libData
{
    public class OrderSearchValue
    {
        ...
        public OrderSearchValue(int idEquip, int idEmpoyee, int flags, int planOutQTY, string dateBegin, string dateEnd, int duration, int factOutQTY, int idManOrderJobItem, string idletime)
        {
